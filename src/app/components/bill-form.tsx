...
export function BillForm({ userId, userRole, onSuccess }: BillFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (insertError) {
        throw new Error(`Failed to submit bill: ${insertError.message}`);
      }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Upload your expense bill for reimbursement
        </CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="is-online">Online Transaction</Label>
              </div>
            </div>
          </div>

          <div className="space-y-2">
            <Label htmlFor="file">Bill Upload</Label>
            <div className="flex items-center gap-4">
              ...
              {file && (
                <div className="relative flex-shrink-0">
                  ...
                  <p className="mt-1 text-xs text-center truncate max-w-24">
                    {file.name}
                  </p>
                </div>
              )}
