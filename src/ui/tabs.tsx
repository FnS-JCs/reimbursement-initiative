...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex w-full items-center justify-start rounded-lg bg-muted p-1 text-foreground",
      className
    )}
    {...props}
  />
